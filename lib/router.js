...
const patterns = [
  ...
  { name: 'status', patterns: ['status', 'cek status', 'cek akun', 'info akun', 'limit'] },
  { name: 'admin', patterns: ['reset', 'reset limit', 'cek user', 'user info', 'ban', 'unban'] },
  ...
  { name: 'group-admin', patterns: ['kick', 'buka grup', 'tutup grup', 'tagall', 'hapus', 'banned', 'protect', 'protection'] },
